...
export class QuickAssignComponent1 extends React.Component<{}, MyStates> {
  constructor(props: {}) {
    super(props);
     this.state = {
       IsRenderReady: false,
      ...
      <div>
        ...
        >
          <Table
            ...
            itemProvider={this.state.UsersAssigned}
            role="table"
...
export default QuickAssignComponent1;

showRootComponent(<QuickAssignComponent1 />);
